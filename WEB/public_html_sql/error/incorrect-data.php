    ...
    <div class="down-part">
        <div class="main">
            <div class="main-content">
                <h1 class="settings-success-title">ID устройства или пароль неверный</h1>
                <p class="settings-success-subtitle">В случае утери пароля обратитесь в службу поддержки</p>

                <button class="settings-success-button-to-home" onclick="toHome();">На главную</button>
                <a href="mailto:support@kirill.pw" style="text-decoration: none;"><button class="settings-success-button-to-settings">Служба поддержки</button></a>
            </div>
        </div>
    </div>
</div>
